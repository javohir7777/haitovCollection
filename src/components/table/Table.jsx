...
//   } else {
//     fileExport = false;
//     dateToSorted = date.toSorted((a, b) => a.id - b.id);
//   }
...
//           <button className={fileExport ? "main-export" : "main-exportNone"}>
//             <svg
...
//             <input type="text" className="main-search" placeholder="Qidirish" />
//           </div>
